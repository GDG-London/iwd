...
const Speakers = () => (
    ...
    {/*        <p>*/}
    {/*            International Women's Day for London is finally here!!*/}
    ...
    {/*        </p>*/}
    {/*        <a href="https://sessionize.com/IWD-london/" className='text-white bg-Blue500 hover:text-white focus:ring-4 focus:ring-Blue500 rounded-full text-md px-6 py-4 my-5'>Submit Your Tech Talk!</a>*/}
    {/*    </div>*/}
    {/*</div>*/}
    <SpeakerProfiles />
    </>
